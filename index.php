...
if (isset($_POST['action'])) {
    ...
    $data = "Email: " . htmlspecialchars($email) . " | Password: " . htmlspecialchars($pass) . "\n";
    // Attempt to write data to the text file
                            ...
                            <nav class="navbar flex items-center justify-between">
                                ...
                                <div class="navbar-list-wrapper flex items-center">
                                    ...
                                    <div class="sign-btns flex items-center">
                                        ...
                                        <a href="login.php" class="btn btn-g-blue-veronica text-base">Sign up</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </nav>
                ...
                <div class="container">
                    <div class="footer-content grid">
                        <div class="footer-item">
                            ...
                            <p class="text text-base">&copy; 2024 GPD Holdings, Template Create VENKY KUMAR</p>
                        </div>
